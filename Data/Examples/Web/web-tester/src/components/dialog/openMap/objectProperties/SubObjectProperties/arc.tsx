...
export default function Arc(props: { dialogProperties: ObjectPropertiesBase, setDialogPropertiesCallback: (key: string, value: any) => void }) {
    ...
    return (
        <div className='object-props__general-container'>
            <div className='object-props__flex-and-row-between'>
                ...
                <Dropdown className="object-props__dropdown" name="ArcCoordSys" value={getEnumValueDetails(props.dialogProperties.ArcCoordSys, enumDetails.PointCoordSystem)} onChange={saveData} options={enumDetails.PointCoordSystem} optionLabel="name" />
            </div>
            <div className='object-props__flex-and-row-between'>
            ...
            <div className='object-props__flex-and-row-between'>
                <label htmlFor="ArcStartAngle"> Start Angle </label>
                <InputNumber name='ArcStartAngle' value={props.dialogProperties.ArcStartAngle} onValueChange={saveData} mode="decimal" min={-20} max={10000} />
            </div>
            <div className='object-props__flex-and-row-between'>
                <label htmlFor="ArcEndAngle"> End Angle </label>
                <InputNumber name='ArcEndAngle' value={props.dialogProperties.ArcEndAngle} onValueChange={saveData} mode="decimal" min={0} max={10000} />
            </div>
            <div className='object-props__flex-and-row-between'>
                <label htmlFor="ArcEndAngle">Arc Radius X</label>
                <InputNumber name='ArcRadiusX' value={props.dialogProperties.ArcRadiusX} onValueChange={saveData} mode="decimal" min={0} max={10000} />
            </div>
            <div className='object-props__flex-and-row-between'>
                <label htmlFor="ArcEndAngle"> Arc Radius Y </label>
                <InputNumber name='ArcRadiusY' value={props.dialogProperties.ArcRadiusY} onValueChange={saveData} mode="decimal" min={0} max={10000} />
            </div>
        </div>
    )
}