...
function
  ...
  const [state,
    dispatch] = useReducer<UseErrorBoundaryReducer>(
  ...
  function
    getWrappedErrorBoundary() {

    // Get current ref value

    let errorBoundaryWrapper: UseErrorBoundaryWrapper = errorBoundaryWrapperRef.current
