 ...
 */
public class DrawObjectResult extends Observable{

    IMcObjectSchemeItem mObjectSchemeItem;
    IMcObject mObj;

    public DrawObjectResult() {
    }

    public void updateDrawObjectResult(IMcObjectSchemeItem objectSchemeItem, IMcObject obj) {
        mObj = obj;
