...
public abstract class MultiLevelListAdapter {
     ...
     */
    protected abstract View getViewForObject(int i, Object object, View convertView, ItemInfo itemInfo);
    ...
    private class ProxyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            return getViewForObject(i,node.getObject(), convertView, node.getItemInfo());
        }
    }
}
