...
{
    public partial class CtrlObjStatePropertyESoundState : CtrlObjStatePropertyDataHandlerESoundState
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyESoundState()
        {
            InitializeComponent(); 
            m_InitValue = DNESoundState._ES_STOPPED;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNESoundState);
        ...
        public DNESoundState RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNESoundState)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNESoundState SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNESoundState)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNESoundState"; }


        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNESoundState)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNESoundState)value;
            SetStateValueByProperty(propertyId, (DNESoundState)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerESoundState : CtrlObjStatePropertyDataHandler<DNESoundState>
    {
