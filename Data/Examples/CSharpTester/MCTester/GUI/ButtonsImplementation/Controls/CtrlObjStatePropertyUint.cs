...
{
    public partial class CtrlObjStatePropertyUint : CtrlObjStatePropertyDataHandlerUint
    {
        public CtrlObjStatePropertyUint()
        {
            InitializeComponent();
            m_InitValue = 0;
        }
        ...
        {
            get { return ntbRegProperty.GetUInt32(); }
            set { ntbRegProperty.SetUInt32(value); }
        }

        public uint SelUintVal
        {
            get { return ntbSelProperty.GetUInt32(); }
            set { ntbSelProperty.SetUInt32(value); }
        }
    ...
    public class CtrlObjStatePropertyDataHandlerUint : CtrlObjStatePropertyDataHandler<uint> { }
}
