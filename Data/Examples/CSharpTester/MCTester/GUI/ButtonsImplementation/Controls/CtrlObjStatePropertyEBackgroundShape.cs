...
{
    public partial class CtrlObjStatePropertyEBackgroundShape : CtrlObjStatePropertyDataHandlerEBackgroundShape
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyEBackgroundShape()
        {
            InitializeComponent();
            m_InitValue = DNEBackgroundShape._EBS_RECTANGLE;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNEBackgroundShape);
        ...
        public DNEBackgroundShape RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNEBackgroundShape)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNEBackgroundShape SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNEBackgroundShape)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNEBackgroundShape"; }

        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNEBackgroundShape)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNEBackgroundShape)value;
            SetStateValueByProperty(propertyId, (DNEBackgroundShape)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerEBackgroundShape : CtrlObjStatePropertyDataHandler<DNEBackgroundShape>
    {
