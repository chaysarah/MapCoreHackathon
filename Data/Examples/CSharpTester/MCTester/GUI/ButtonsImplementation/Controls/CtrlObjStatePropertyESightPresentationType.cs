...
{
    public partial class CtrlObjStatePropertyESightPresentationType : CtrlObjStatePropertyDataHandlerESightPresentationType
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyESightPresentationType()
        {
            InitializeComponent();
            m_InitValue = DNESightPresentationType._ESPT_NONE;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNESightPresentationType);
        ...
        public DNESightPresentationType RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNESightPresentationType)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNESightPresentationType SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNESightPresentationType)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNESightPresentationType"; }

        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNESightPresentationType)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNESightPresentationType)value;
            SetStateValueByProperty(propertyId, (DNESightPresentationType)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerESightPresentationType : CtrlObjStatePropertyDataHandler<DNESightPresentationType>
    {
