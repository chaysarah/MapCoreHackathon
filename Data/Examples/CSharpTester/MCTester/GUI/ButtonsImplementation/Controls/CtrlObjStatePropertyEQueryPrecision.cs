...
{
    public partial class CtrlObjStatePropertyEQueryPrecision : CtrlObjStatePropertyDataHandlerEQueryPrecision
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyEQueryPrecision()
        {
            InitializeComponent();
            m_InitValue = DNEQueryPrecision._EQP_DEFAULT;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNEQueryPrecision);
        ...
        public DNEQueryPrecision RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNEQueryPrecision)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNEQueryPrecision SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNEQueryPrecision)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNEQueryPrecision"; }

        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNEQueryPrecision)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNEQueryPrecision)value;
            SetStateValueByProperty(propertyId, (DNEQueryPrecision)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerEQueryPrecision : CtrlObjStatePropertyDataHandler<DNEQueryPrecision>
    {
