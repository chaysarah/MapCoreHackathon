...
{
    public partial class CtrlObjStatePropertyELineStyle : CtrlObjStatePropertyDataHandlerELineStyle
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyELineStyle()
        {
            InitializeComponent();
            m_InitValue = DNELineStyle._ELS_SOLID;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNELineStyle);
        ...
        public DNELineStyle RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNELineStyle)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNELineStyle SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNELineStyle)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNELineStyle"; }

        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNELineStyle)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNELineStyle)value;
            SetStateValueByProperty(propertyId, (DNELineStyle)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerELineStyle : CtrlObjStatePropertyDataHandler<DNELineStyle>
    {
