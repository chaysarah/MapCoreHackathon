...
{
    public partial class CtrlObjStatePropertyEBasePointAlignment : CtrlObjStatePropertyDataHandlerEBasePointAlignment
    {
        private Type m_RegEnumType = null;
        private Type m_SelEnumType = null;
        private string m_EnumType = null;

        public CtrlObjStatePropertyEBasePointAlignment()
        {
            InitializeComponent();
            base.m_InitValue = DNEBasePointAlignment._EBPA_BOUNDING_BOX_CENTER;
            SetEnumList();
        }
        ...
        private void SetEnumList()
        {
            ...
            Type enumType = typeof(DNEBasePointAlignment);
        ...
        public DNEBasePointAlignment RegEnumVal
        {
            get
            {
                if (cmbRegEnum.SelectedItem != null)
                    return (DNEBasePointAlignment)Enum.Parse(m_RegEnumType, cmbRegEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public DNEBasePointAlignment SelEnumVal
        {
            get
            {
                if (cmbSelEnum.SelectedItem != null)
                    return (DNEBasePointAlignment)Enum.Parse(m_SelEnumType, cmbSelEnum.SelectedItem.ToString());
                else
                    return 0;
            }
            set
        ...
        public override string GetPropertyEnumType() { return "DNEBasePointAlignment"; }

        public override void SetValue(uint propertyId, object value)
        {
            if (RegPropertyID == propertyId)
                RegEnumVal = (DNEBasePointAlignment)value;
            if (SelPropertyID == propertyId)
                SelEnumVal = (DNEBasePointAlignment)value;
            SetStateValueByProperty(propertyId, (DNEBasePointAlignment)value);
        }
    ...
    public class CtrlObjStatePropertyDataHandlerEBasePointAlignment : CtrlObjStatePropertyDataHandler<DNEBasePointAlignment>
    {
