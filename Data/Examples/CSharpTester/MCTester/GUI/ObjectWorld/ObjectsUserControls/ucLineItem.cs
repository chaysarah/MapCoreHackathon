...
{
    public partial class ucLineItem : ucLineBasedItem, IUserControlItem
    {
        private IDNMcLineItem m_CurrentObject;
        ...
        {
            m_CurrentObject = (IDNMcLineItem)aItem;
            ...
            try
            {
                ctrlObjStatePropertyLineSlopeQueryPrecision.Load(m_CurrentObject.GetSlopeQueryPrecision);
            }
            catch (MapCoreException McEx)
            {
        ...
        protected override void SaveItem()
        {
            ...
            try
            {
                ctrlObjStatePropertyLineSlopeQueryPrecision.Save(m_CurrentObject.SetSlopeQueryPrecision);
            }
            catch (MapCoreException McEx)
            {
